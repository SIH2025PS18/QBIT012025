...
import '../onboarding/nabha_profile_setup_screen.dart';
...
class _PhoneRegisterScreenState extends State<PhoneRegisterScreen> {
  ...
  Future<void> _sendOtp() async {
    ...
    try {
      // Send real OTP using Supabase + Twilio
      final success = await PhoneAuthService.sendRegistrationOtp(
  ...
  Future<void> _verifyOtpAndRegister() async {
    ...
    try {
      // Register user with real OTP verification
      final userData = await PhoneAuthService.registerWithPhone(
      ...
      if (userData != null && mounted) {
        ...
        // Successfully registered, navigate to profile setup screen
