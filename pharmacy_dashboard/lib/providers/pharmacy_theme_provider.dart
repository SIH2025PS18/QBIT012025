...
class PharmacyThemeProvider extends ChangeNotifier {
  bool _isDarkMode = false; // Start with light mode as default for pharmacy
  late SharedPreferences _prefs;

  bool get isDarkMode => _isDarkMode;

  // Light theme for pharmacy dashboard
  ...
  // Dark theme for pharmacy dashboard
  ThemeData get darkTheme => ThemeData(
    ...
    drawerTheme: const DrawerThemeData(backgroundColor: Color(0xFF1A1B23)),
    listTileTheme: const ListTileThemeData(
  ...
  Future<void> initializeTheme() async {
    ...
    _isDarkMode =
        _prefs.getBool('pharmacy_isDarkMode') ?? false; // Default to light
    notifyListeners();
  }

  Future<void> toggleTheme() async {
    _isDarkMode = !_isDarkMode;
    await _prefs.setBool('pharmacy_isDarkMode', _isDarkMode);
    notifyListeners();
  }
  ...
  // Helper methods for consistent colors across the pharmacy dashboard
  ...
  Color get accentColor => const Color(0xFF2E7D8F);
